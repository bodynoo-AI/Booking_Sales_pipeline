...
exports.checkConflicts = exports.listConflicts = void 0;
const conflictService = __importStar(require("../services/conflict.service"));
const listConflicts = async (_req, res) => {
    try {
